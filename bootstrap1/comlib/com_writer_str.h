 ...
 * REQUIRES: `destination` is a valid pointer to a valid `com_str_mut` that will be written to
 ...
 */
com_writer com_writer_str_create(com_str_mut* destination, usize offset, com_writer_str_backing *backing);
