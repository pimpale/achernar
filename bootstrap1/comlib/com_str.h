 ...
 */
com_str com_str_create(const u8* data, usize len);
com_str com_str_create_c(const u8* data, usize len);
 ...
 */
com_str com_str_asciiz(const u8* asciiz);
 ...
 */
#define com_str_lit_m(literal) com_str_create((const u8*)(literal), sizeof(literal)-1)
